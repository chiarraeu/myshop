...
*/        
    ...
    {
        // Register the cookies service provider:
        $this->app->register(ServiceProvider::class);

        // Register the cookies middleware:
        $this->app['router']->aliasMiddleware('cookies', \Whitecube\LaravelCookieConsent\Middleware\Consent::class);
    }
    */
}
